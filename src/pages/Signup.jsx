...
function Signup() {
  ...
  const handleSubmit = async (e) => {
    const stringRegex = /^[a-zA-Z0-9_.\s-]{2,}$/;
          ...
          <div className="max-w-[450px] h-auto mx-auto bg-white/75 rounded-3xl">
            <div className="max-w-[320px] mx-auto pt-16 pb-5">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col w-full py-4">
                ...
                />
                {showError && (
                  <div className="p-4 my-2 text-sm text-red-600 bg-red-100 rounded-lg" role="alert">
                    <span className="font-medium">{error}</span>
                  </div>
                )}
                {isLoading ? (
                  <button className="py-3 my-3 font-bold bg-gray-200 rounded-lg">
                    <svg
                      aria-hidden="true"
                      role="status"
                      className="inline w-4 h-4 mr-3 text-gray-400 animate-spin"
                      viewBox="0 0 100 101"
                      fill="none"
